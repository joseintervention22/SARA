...
<div class="col-md-2">
    ...
    <div class="col-md-10">
        ...
        <div class="box-header with-border">
            ...
            <form class="navbar-form navbar-left pull-right" method="GET" action="{{route('reembolso.finanza.cons')}}" role="search"> 
                              ...
                              <tbody>
                                  @foreach ($reembolsos as $rm)
                                    <tr>
                                        ...
                                        <td class="mailbox-name"><a href="{{route('reembolso.finanza.detalle',$rm->id)}}">Reembolso Num. {{$rm->consecutivo}}</a></td>
