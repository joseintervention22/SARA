        ...
        <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    @if ($rm->estado==2)
                        ...
                        <td><a href="{{route('reembolso.firma.detalle',$rm->id)}}" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-envelope"> </span>revisar</a>
